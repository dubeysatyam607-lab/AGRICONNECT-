...
**Vulnerable Code:**
```
ELEVEN_LABS_API_KEY=***REDACTED-ROTATE-KEY***
...
1. **REVOKE immediately:**
   ...
   # 2. Delete the key: ***REDACTED-ROTATE-KEY***
   # 3. Generate new key
   ```
...
git log --all --full-history -S "***REDACTED-ROTATE-KEY***"
...
- **Time:** 15 minutes
- **Action:** Delete `***REDACTED-ROTATE-KEY***` from ElevenLabs
- **Steps:**
  1. Go to ElevenLabs dashboard
