  ...
  return (
    <button
      ...
      className={cn(
        ...
        " bg-white/75 dark:bg-slate-900/75 border border-white/60 dark:border-white/10",
        "rounded-[24px] shadow-[0_6px_24px_rgba(0,0,0,0.05)]",
        "transition-all duration-300 ease-out will-change-transform",
        "hover:-translate-y-1.5 hover:scale-[1.06] hover: hover:border-emerald-500/40",
        "active:scale-90 active:transition-transform",
        "overflow-hidden cursor-pointer",
        highlight && "bg-emerald-700 border-emerald-500/40 ",
        className
      )}
    >
      ...
      <div className="absolute -inset-1 bg-emerald-700 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
      ...
      <div
        className={cn(
          "w-13 h-13 rounded-xl overflow-hidden flex items-center justify-center transition-all duration-300 ease-out",
      ...
      <span
        className={cn(
          "text-xs font-semibold text-slate-800 dark:text-slate-100 text-center leading-tight tracking-tight line-clamp-2 w-full",
