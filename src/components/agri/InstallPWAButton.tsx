...
const InstallPWAButton: React.FC = () => {
  ...
  if (installedSuccess) {
    return (
      <div className="flex items-center gap-3 rounded-xl bg-emerald-600 px-4 py-3 text-sm font-bold text-white shadow-lg ">
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-primary/20 bg-card/95  px-4 py-3 shadow-card">
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary/10 text-primary">
        <Smartphone size={18} />
      </div>
      <div className="flex-1 min-w-0">
        <p className="text-sm font-bold text-foreground leading-tight">Install AgriConnect</p>
        <p className="text-xs text-muted-foreground mt-0.5">Works offline & loads faster</p>
      </div>
      <button
