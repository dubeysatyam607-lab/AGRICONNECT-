...
export const ListeningOverlay: React.FC<ListeningOverlayProps> = ({
  ...
  <div className="absolute inset-0 z-50 bg-white/95  flex flex-col items-center justify-center px-6 text-foreground animate-in fade-in duration-300">
    <GlowOrb size={120}>
    ...
    <div className="w-full max-w-md mt-6">
      <div className="bg-muted border border-border rounded-xl p-4 min-h-[72px]">
        {transcript ? (
          <p className={cn(
    ...
    <div className="flex items-center gap-4 mt-8">
      ...
      <button
        ...
        className="flex items-center gap-2 text-xs font-bold text-white bg-primary disabled:opacity-40 disabled:pointer-events-none rounded-full px-6 py-2.5 shadow-lg  transition-all active:scale-95"
      >
        <Check size={14} /> Done
      </button>
    </div>
