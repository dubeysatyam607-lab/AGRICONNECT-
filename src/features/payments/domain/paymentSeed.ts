...
const seedPlans = (): PlanDefinition[] => [
  ...
  },
  {
    ...
    priceMonthly: 99,
    priceYearly: 990,
    features: ['Unlimited AI assistant', 'Crop Doctor unlimited', 'Price alerts', 'Priority support'],
  },
  {
    id: 'plan-pro',
    name: 'Kisan AI Pro',
    ...
    trialDays: 7,
    popular: true,
    features: ['Everything in Plus', 'AI crop advisor', 'Yield forecasting', 'Advanced analytics'],
  },
];
