...
export const ProfileAvatarUploader: React.FC<IProfileAvatarUploaderProps> = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center gap-5 p-4 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 transition-all">
      {/* Avatar Circle */}
      <div
        className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden border-4 border-white dark:border-slate-800 shadow-md flex items-center justify-center bg-emerald-900 text-white font-semibold text-2xl cursor-pointer group shrink-0"
      ...
      >
        ...
        >
          ...
          <span className="text-xs uppercase font-bold tracking-wider text-white">{t('pdetail.change')}</span>
        </div>
      ...
      <div className="space-y-2 text-center sm:text-left">
        <div>
          <h4 className="text-base font-semibold text-foreground">{t('pdetail.profilePicture')}</h4>
