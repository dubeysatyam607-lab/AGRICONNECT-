...
export const AppBottomSheet: React.FC<IAppBottomSheetProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 ">
      <div className="w-full max-w-2xl bg-white dark:bg-slate-900 rounded-t-3xl max-h-[85vh] flex flex-col  border-t border-slate-200 dark:border-slate-800  overflow-hidden">
        {/* Grabber handle */}
