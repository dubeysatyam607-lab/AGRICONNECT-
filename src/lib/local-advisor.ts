...
const FOUR_PART_PESTS: Record<string, FourPartSolution> = {
 ...
 warning: {
 hi: " सावधानी: किसी भी रासायनिक कीटनाशक के प्रयोग से पहले स्थानीय कृषि विज्ञान केंद्र (KVK) या कृषि अधिकारी से पुष्टि करें। पहले एक छोटे हिस्से पर परीक्षण करें और मधुमक्खी भ्रमण के समय स्प्रे न करें।",
 en: " Warning: Confirm with your local Krishi Vigyan Kendra (KVK) or Agriculture Extension Officer before applying chemical sprays. Test on a small patch first and avoid spraying during peak pollinator hours."
 }
 },
 whitefly: {
 ...
 warning: {
 hi: " सावधानी: बार-बार एक ही रसायन न दोहराएं ताकि कीट में प्रतिरोधकता न बने। स्प्रे से पहले स्थानीय KVK वैज्ञानिक की सलाह अवश्य लें।",
 en: " Warning: Rotate chemical modes of action to prevent pesticide resistance. Consult your local agricultural officer before spraying."
 }
 },
 bollworm: {
 ...
 warning: {
 hi: " सावधानी: तुड़ाई से कम से कम 10-14 दिन पहले कीटनाशक स्प्रे बंद कर दें (Waiting Period का पालन करें)। सटीक खुराक हेतु स्थानीय कृषि अधिकारी से परामर्श लें।",
 en: " Warning: Adhere strictly to the pre-harvest interval (PHI 10-14 days). Always consult your local KVK for verified field-level dosages."
 }
 },
 caterpillar: {
 ...
 warning: {
 hi: " सावधानी: स्प्रे हमेशा शाम के समय करें जब इल्लियां बाहर निकलती हैं। दवा छिड़कते समय मास्क व दस्ताने अवश्य पहनें।",
 en: " Warning: Spray during late afternoon/dusk when larvae actively feed. Always wear protective gear and verify with local agronomists."
 }
 },
 thrips: {
 ...
 warning: {
 hi: " सावधानी: अत्यधिक यूरिया का उपयोग न करें जिससे पत्तियों में कोमलता बढ़ती है। रासायनिक स्प्रे से पहले KVK से सलाह लें।",
 en: " Warning: Avoid excessive nitrogen fertilizer which encourages thrips buildup. Always seek KVK confirmation for chemical dosages."
 }
 },
 mite: {
 ...
 warning: {
 hi: " सावधानी: सल्फर का छिड़काव तेज धूप या 35°C से अधिक तापमान में न करें। कृषि विशेषज्ञ की सलाह अवश्य लें।",
 en: " Warning: Do not apply sulfur during high heat (>35°C) to prevent leaf burn. Verify treatment with an agronomist."
 }
 },
 termite: {
 ...
 warning: {
 hi: " सावधानी: दीमक नाशक रसायनों का प्रयोग सीधे पीने के पानी के स्रोतों के निकट न करें। स्थानीय कृषि विशेषज्ञ से मार्गदर्शन लें।",
 en: " Warning: Avoid chemical runoff near groundwater sources. Confirm proper application with your local agriculture department."
 }
 }
};
...
const FOUR_PART_DISEASES: Record<string, FourPartSolution> = {
 ...
 warning: {
 hi: " सावधानी: बारिश से पहले या तेज हवा में स्प्रे न करें। फफूंदनाशक की सटीक खुराक के लिए स्थानीय KVK से परामर्श लें।",
 en: " Warning: Do not spray immediately before rainfall or in strong winds. Always confirm fungicide timing with local KVK experts."
 }
 },
 rust: {
 ...
 warning: {
 hi: " सावधानी: रतुआ हवा से तेजी से फैलता है, लक्षण दिखते ही तुरंत उपचार करें और नजदीकी कृषि अधिकारी (KVK) को सूचित करें।",
 en: " Warning: Rust spreads airborne very rapidly across neighbouring fields. Seek immediate agronomic confirmation from your KVK."
 }
 },
 powderyMildew: {
 ...
 warning: {
 hi: " सावधानी: सल्फर का स्प्रे 32°C से ऊपर तापमान में न करें। दवा का उपयोग पैकेट पर लिखे निर्देशानुसार ही करें।",
 en: " Warning: Avoid sulfur sprays during high ambient temperature. Verify fungicide rates with your local agriculture center."
 }
 },
 wilt: {
 ...
 warning: {
 hi: " सावधानी: उकठा रोग में खड़ी फसल पर पत्ती स्प्रे काम नहीं करता, केवल जड़ के पास घोल (Drenching) देना जरूरी है। KVK से सलाह लें।",
 en: " Warning: Foliar spraying is ineffective for wilt — root-zone drenching is mandatory. Verify treatment with local farm experts."
 }
 },
 leafCurl: {
 ...
 warning: {
 hi: " सावधानी: विषाणु रोग तेजी से पूरी फसल में फैलते हैं, इसलिए वाहक कीट नियंत्रण अत्यंत आवश्यक है। कृषि अधिकारी से संपर्क करें।",
 en: " Warning: Viral spread requires immediate vector management. Seek formal confirmation from local extension officers."
 }
 },
 yellowLeaves: {
 ...
 warning: {
 hi: " सावधानी: अत्यधिक यूरिया का एकमुश्त प्रयोग न करें। सटीक पोषक तत्व प्रबंधन हेतु अपने खेत का मृदा स्वास्थ्य कार्ड (Soil Health Card) जांचें व KVK से सलाह लें।",
 en: " Warning: Avoid sudden heavy urea applications. Base micronutrient corrections on your Soil Health Card and consult your local KVK agronomist."
 }
 }
};
